...
export const he: Content = {
  ...
  why: {
    ...
    intro:
      'ארבעה רעיונות מההרצאה שלנו ב-UXI 2026 על עיצוב עם AI. שאר האתר הופך אותם לכלים שאפשר להשתמש בהם כבר היום.',
    takeaways: [
      {
        number: '01',
      ...
      },
      {
        ...
        body:
          'מוצר עובד תמיד ינצח מילים. כשעלות בניית POC יורדת, הרבה יותר קל להוכיח רעיון — גם בלי משאבים רשמיים. שני דברים שמאפשרים את זה: **Vibe coding** (כלי AI שמאפשרים למעצבים לבנות פרוטוטיפים אמיתיים תוך שעות) ו**שיתופי פעולה "מתחת לשולחן"** (הקשרים בארגון שהופכים לעזרה אמיתית ברגע הנכון).',
      },
      {
        number: '03',
      ...
      },
      {
        ...
        body:
          'הבנה עמוקה של יוזרים, חשיבה מוצרית, עבודה עם צוותים. את השאר — כמו Prompt Engineering — אפשר ללמוד. בדיוק בשביל זה קיים שאר האתר.',
      },
    ],
  },
  poc: {
  ...
  principles: {
    ...
    starterPromptNote:
      'לא רוצים לזכור את תשעת המהלכים למעלה? הפרומפט מערכת הזה מיישם את כולם בשבילכם. הדביקו אותו בכל צ׳אט — Gemini, ChatGPT, Claude, איפה שתרצו. המודל יענה ויבקש את הפרומפט הגולמי שלכם. שלחו לו אותו בהודעה הבאה, ותקבלו בחזרה גרסה חדה יותר עם כל חוק מהאתר הזה מיושם עליה. לא צריך לערוך את הבלוק עצמו.',
  ...
  who: {
    tag: '§ מי',
    meta: 'הבונים · המרצים',
    title: 'העברנו את ההרצאה. בנינו את האתר הזה.',
    intro:
      'שני אנשי מוצר ב-Lightricks, שמהמרים שהתפקיד של המעצב עכשיו כולל גם לבנות את הדבר בפועל. האתר הזה הוא ההוכחה.',
    ...
    list: [
      ...
      },
      {
        ...
        bio:
          'מוביל אסטרטגיה מוצרית-טכנולוגית ל-Generative AI ברחבי Lightricks, במיליוני יוזרים. דותן הצטרף לפרויקט כ-Prompt Engineer, לימד את המעצבות לכתוב את הכללים — וויב־קוד את האתר הזה באחר צהריים.',
        initials: 'דב',
    ...
    watchUxiLabel: 'אתר ההרצאה ב-UXI Live →',
  ...
  lecture: {
    ...
    slides: en.lecture.slides.map((s, i) => ({
      file: s.file,
      caption: [
        'שקופית פתיחה — הכותרת והדוברים',
        'הבעיה — ״אני שונאת כשיוצאת לי תמונה מכוערת״',
        'ככה גם רוב היוזרים של פייסטון',
        'המענה היום — אדיטור',
        'לתפוס את הרגע הכי פוטוגני',
        'טכנולוגיה חדשה — אותה הבעיה',
        '״תמונה מכוערת?״ — תהייה',
        'הרעיון — מה אם כל תמונה הייתה של צלם מקצועי?',
        'צלם מקצועי שמכיר אותנו ויודע להוציא את הטוב',
        'קיר של פרומפט — מה שהיוזר היה צריך לכתוב',
        'נסתר מהיוזר — הפרומפט שמאחורי התמונה',
        'דיאגרמה — בעיה ⟵ פתרון ⟵ שאטר באטן',
        'טה־דה!',
        '״אוקיי… מי לוקח את זה מכאן?״',
        'האדסקר פרוקסי — הזקן והנייר',
        '״תבין, זה לילדים״ — עיגול על שקית',
        'ג׳מיני — ״give me a different pose״',
        'AI Studio — הפרוטוטיפ באייפד',
        'קוד + תמונה אמיתית מהפארק — ה־POC',
        'רשת תנוחות — מה עבד ומה לא',
        'מטריצת איטרציה — V1 / V2',
        'מוקאפ המוצר — חוויית השאטר',
        'המטרה המוצרית היא העוגן',
        'סלאק — ״בילד וואו · כיפי · קליל · יש value״',
        'סלאק — תגובת נטע ו״מושלם בעיניי״ של דותן',
        'התהליך — סקיצה מנוקה',
        '01 — היכולות שלי משתנות',
        '02 — היכרות עם הארגון ועבודת צוות',
        '03 — מוצר שעובד מנצח מילים',
        'סגירה — בחזרה להאדסקר',
      ][i] ?? s.caption,
    })),
