...
export const he: Content = {
  ...
  hero: {
    ...
    subhead:
      'הערכה המינימלית למעצבים כדי לעבור מצפייה בהרצאה לשיפ של POC עובד מבוסס AI — בפחות משעתיים.',
    receiptPrefix: 'נבנה',
  ...
  poc: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'בזמן שאתם בונים, AI Studio משתמש בקריאות מוקאפ כדי שלא תשרפו מכסה. כשאתם מוכנים לבדוק עם פלט אמיתי של Gemini או Nano Banana, שימו API key. אין לכם? **תבקשו ממישהו בקבוצת הפיתוח שלכם.** לרוב החברות כבר יש מפתחות פרויקט שאפשר להשאיל לפרוטוטייפינג — בלי אשראי, בלי רכש, בלי לחכות.',
      ...
      },
      {
        ...
        body:
          'שלחו את הלינק או שתפו מסך. תסתכלו על הפנים שלהם. אם הם נרתעים, הפרומפט הוא הבעיה — לא המודל. תעשו שיפ לגרסה גולמית, תלמדו מהר, ואז תעשו פוליש. זה כל השינוי שההרצאה מדברת עליו: מעצבים יכולים עכשיו לבנות את הדבר שפעם הם היו רק נותנים עליו בריף.',
